...
export const products = [
  ...
  {
    id: 8,
    title: "mockup-free-lotion",
    category: "Lotion",
    image: "mockup-free-lotion.png",
    price: 27.99,
    description: [
...
export default function Products() {
    ...
    setSort(e.target.value)
          ...
          filteredList.map( cart => (
            <section key={cart.id} className='px-14 py-3'>
              <Link href={`/Shop/${cart.title.split(' ').join('-')}`}>
                  <Image src={`/${cart.image}`} alt={cart.title} width={300} height={300} className='h-48 w-48 rounded-sm bg-zinc-200'/>
  ...
  return (
    ...
    <div className='grid grid-cols-12 px-20 my-32'>
      <div className='col-span-3 pt-6'>
              <div className='flex items-center border-2 border-gray-300 rounded-full m-auto w-1/2 p-2 leading-4'>

                <input type="text" name='text' id='text' placeholder='search...' className='outline-none border-none pl-8 w-5/6'
                defaultValue={sort}
            ...
            <div className='pt-7 px-10'>
              ...
              <div className='border-y-2 leading-10'>
                ...
                <ul>
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Skin-Care</li>
                  </Link>
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Lotion</li>
                  </Link>
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Perfume</li>
                  </Link>
                </ul>
              </div>
              <div className='leading-10'>
                ...
                <ul>
                  ...
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Face-Wash</li>
                  </Link>
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Lotion</li>
                  </Link>
                  ...
                  <Link href='/Shop'>
                    <li className='text-slate-600'>Men's kit</li>
                  </Link>
                </ul>
              </div>
